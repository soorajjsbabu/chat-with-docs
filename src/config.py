...
OLLAMA_URL = os.getenv("OLLAMA_URL", "http://localhost:11434")  # Base URL for the local Ollama API server
...
TOP_K = 8                                                       # Number of top similar chunks to retrieve from the vector store for each query
