...
CHUNK_SIZE = 800                       # Maximum number of characters per document chunk for embedding
CHUNK_OVERLAP = 150                    # Number of characters to overlap between consecutive chunks for context continuity
TOP_K = 4                              # Number of top similar chunks to retrieve from the vector store for each query
